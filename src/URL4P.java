...
public class URL4P {
    ...
    public static void main(String[] args){
        ...
        HashMap<String, String> latestMutualFunPrices = new HashMap<>();

        int i = 0;
        while(listOfMutualFunds.size() > i){
            latestMutualFunPrices.put(listOfMutualFunds.get(i),Fetcher.fetcher(listOfMutualFunds.get(i)));
            i++;
        }

        //Create new file per key in hasmap
        try{
            for(Map.Entry<String, String> entry : latestMutualFunPrices.entrySet()){
        ...
        System.out.println(latestMutualFunPrices);
